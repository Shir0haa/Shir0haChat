...
class MessageListModel : public QAbstractListModel
{
  ...
  public:
    ...
    Q_INVOKABLE QString appendMessage(const QString& senderId, const QString& content, bool isMine,
                                      const QString& timestamp);

    void appendMessage(const Message& msg, bool isMine);
    void appendMessage(const Message& msg, bool isMine, const QString& senderNickname);

    void resetMessages(const QList<Message>& messages, const QString& selfUserId,
